    ...
    <section className="text-gray-600 body-font relative">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-col text-center w-full mb-12">
          <h1 className="sm:text-3xl text-2xl title-font mb-4 font-extrabold">Contact Us</h1>
         ...
         <div className="lg:w-1/2 md:w-2/3 mx-auto">
          <div className="flex flex-wrap -m-2">
            ...
            <div className="p-2 w-full">
              <button
                className="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Submit
              </button>
            </div>
        ...
        {/*           className="w-5 h-5" viewBox="0 0 24 24" data-darkreader-inline-fill=""*/}
        ...
        {/*    <a className="ml-4 text-gray-500">*/}
        {/*      <svg fill="none"*/}
        {/*           className="w-5 h-5" viewBox="0 0 24 24" data-darkreader-inline-stroke=""*/}
