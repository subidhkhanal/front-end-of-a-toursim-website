      ...
      <div className="popularpackagescollection__package">
        ...
        <div className="popularpackagescollection__all-down rounded-b-3xl">
          ...
          <div className="flex justify-center">
            <button className="bg-indigo-500 mx-auto py-2 px-8 text-center text-xl rounded-full border-0 hover:shadow-lg transition duration-200 ease-in-out hover:bg-indigo-600 text-white">View Details</button>
          </div>
        </div>
      </div>
    </div>
